    ...
    private static readonly IReadOnlyDictionary<AppLanguage, IReadOnlyDictionary<LocalizedText, string>> Catalog =
        new Dictionary<AppLanguage, IReadOnlyDictionary<LocalizedText, string>>
        {
            [AppLanguage.SimplifiedChinese] = new Dictionary<LocalizedText, string>
            {
                ...
                [LocalizedText.SettingsPresetFiftyTen] = "50 / 10",
                [LocalizedText.AboutTitle] = "About",
                [LocalizedText.AboutVersionLabel] = "版本",
                [LocalizedText.AboutAuthorsLabel] = "作者",
                ...
                [LocalizedText.TaskAdd] = "添加任务",
                [LocalizedText.TaskUse] = "开始此任务",
                [LocalizedText.TaskDelete] = "删除任务",
                [LocalizedText.TaskPending] = "进行中",
                [LocalizedText.TaskCompleted] = "已完成",
                [LocalizedText.TaskNoItems] = "今天还没有添加任务",
                [LocalizedText.TaskPomodoroCountFormat] = "{0} 个番茄",
                [LocalizedText.TaskMarkDone] = "标记完成",
                [LocalizedText.TaskMarkPending] = "标记未完成",
            ...
            [AppLanguage.TraditionalChinese] = new Dictionary<LocalizedText, string>
            {
                ...
                [LocalizedText.TaskAdd] = "新增任務",
                [LocalizedText.TaskUse] = "開始此任務",
                [LocalizedText.TaskDelete] = "刪除任務",
                [LocalizedText.TaskPending] = "進行中",
                [LocalizedText.TaskCompleted] = "已完成",
                [LocalizedText.TaskNoItems] = "今天還沒有新增任務",
                [LocalizedText.TaskPomodoroCountFormat] = "{0} 個番茄",
                [LocalizedText.TaskMarkDone] = "標記完成",
                [LocalizedText.TaskMarkPending] = "標記未完成",
            ...
            [AppLanguage.English] = new Dictionary<LocalizedText, string>
            {
                ...
                [LocalizedText.SettingsPresetFiftyTen] = "50 / 10",
                [LocalizedText.AboutTitle] = "About",
                [LocalizedText.AboutVersionLabel] = "Version",
                [LocalizedText.AboutAuthorsLabel] = "Authors",
                [LocalizedText.LanguageSimplifiedChinese] = "简体中文",
                [LocalizedText.LanguageTraditionalChinese] = "繁體中文",
                [LocalizedText.LanguageEnglish] = "English",
                [LocalizedText.TaskUntitled] = "Untitled Task",
                [LocalizedText.TaskAdd] = "Add Task",
                [LocalizedText.TaskUse] = "Use Task",
                [LocalizedText.TaskDelete] = "Delete Task",
                [LocalizedText.TaskPending] = "In Progress",
                [LocalizedText.TaskCompleted] = "Completed",
                [LocalizedText.TaskNoItems] = "No tasks added today",
                [LocalizedText.TaskPomodoroCountFormat] = "{0} pomodoros",
                [LocalizedText.TaskMarkDone] = "Mark Done",
                [LocalizedText.TaskMarkPending] = "Mark Pending",
