...
- `PomodoroTimer.Tests/`: xUnit regression coverage for timer, localization, and
  view-model behavior
...
- The checked-in GitHub Actions workflow is still a placeholder desktop template
  and is tracked as debt in
