...
This repository is a .NET 8 / Avalonia desktop Pomodoro timer. Treat the
...
- `PomodoroTimer/Program.cs`: desktop entry point and Avalonia bootstrap
- `PomodoroTimer/App.axaml`: application-wide resources
- `PomodoroTimer/Views/MainWindow.axaml`: main window layout and bindings
...
- `PomodoroTimer.Tests/`: xUnit coverage for timer, localization, and view-model
  behavior
- `.github/workflows/dotnet-desktop.yml`: legacy placeholder CI; see
...
6. When blocked, add missing context, tooling, or constraints to the repository
